...
export class CarbonVerticalContainer<T extends CarbonContainerable = CarbonContainerable> extends CarbonMultiContainer<T> {
	
	// DOC-ME [12/8/18 @ 4:53 PM] - Documentation required!
	public constructor(containerType: CarbonContainerType = CarbonContainerType.DIV) {
		
		super(containerType);
		this.setTypeIdentity("carbon-vertical-container");
